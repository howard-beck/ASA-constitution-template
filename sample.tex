...
\article{Changes}
testing
\changes{Here was some old text}{and here's the new text}{We wanted to make this change for a very important reason that pertains to a scenario in which our operations were affected by our ability to undergo certain }
...
\changes{
    ...
    \section{new testing}
    But now it really should be here
}{
    for testing reasons
}
