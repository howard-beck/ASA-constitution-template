...
\newcommand{\declareHeaderAtCount}[4]{%
    ...
    %\typeout{index of #2: \csname#2index\endcsname}
    ...
    %\typeout{#2: \expandafter\expandafter\expandafter\expandafter\sectionIndex}
    %\edef\oldtotal{\getidx\@sectionTotalsHistory{\sectionIndex}}
    
    %
    %\@ifundefined{@#2counter}%
    %{%
    %    \makearr{@#2counterHistory}%
    %}%
    %{}%
    %\setidx
}
